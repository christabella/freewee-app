...
//      *USER_SCALE — allows you to have custom dynamic scaling, calculating the size, scale and ratio on your own; again, this is more of an advanced mode
        ...
        game.load.spritesheet('sumoSS','/sumo/img/sumoRunSpriteSheet.png',773,914);
        
        game.load.image('track','/sumo/img/track.png');
        game.load.audio('breathing','/sumo/sound/breathShort.mp3');
        game.load.audio('cheering','/sumo/sound/cheerSoundShort.mp3');
        game.load.audio('countdown','/sumo/sound/countdown.mp3');
        game.load.audio('collisionSound','/sumo/sound/collision.mp3');
    ...
    update:function() {
       ...
       game.physics.arcade.collide(collisionGroup,collisionGroup,this.slowDown,null,this);
        ...
        collisionGroup.forEach(function(member){
            ...
            // increase speed for sumos if gamma high enough
