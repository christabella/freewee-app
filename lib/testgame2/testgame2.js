...
router.use(function(req, res, next){
  if (isCallerMobile(req)){
    var template = __dirname + '/views/player';
    var context = {
        siteTitle : "PLAYER"
...
// Module's Routes. Please note this is actually under /testgame, because module is attached under /hello
router.get('/', function(req, res) {
    var template = __dirname + '/views/testgame2';
    var context = {
        siteTitle : "TEST GAME"
