        ...
        case "orientationAndMotion":
          if (window.DeviceOrientationEvent && window.DeviceMotionEvent) {
            ...
            var orientationListener = function (eventData) {
              ...
              if(Math.abs(orientation.alpha - _instance.prevOrientation.alpha) >= 5 ||
                  Math.abs(orientation.beta - _instance.prevOrientation.beta) >= 5 ||
                  Math.abs(orientation.gamma - _instance.prevOrientation.gamma) >= 5
                  ) {
